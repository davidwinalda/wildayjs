...
async function getCurrentVersion() {
  ...
  try {
    // Get current version
    const version = await wildayjs.migrate.currentVersion();
    ...
    const migrationRecord = await wildayjs("wildayjs_migrations")
    ...
    if (error.message.includes("wildayjs_migrations")) {
