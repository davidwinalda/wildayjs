...
const seedTemplate = require("./seed");
const createTableWithSeedTemplate = require("./create_table_with_seed");
const createHasOneWithSeedTemplate = require("./seeds/create_has_one_with_seed");
const addColumnWithSeedTemplate = require("./seeds/add_column_with_seed");
const addColumnSeedTemplate = require("./seeds/add_column_seed");
...
module.exports = {
  ...
  seedTemplate,
  createTableWithSeedTemplate,
  createHasOneWithSeedTemplate,
  addColumnWithSeedTemplate,
  addColumnSeedTemplate,
};
