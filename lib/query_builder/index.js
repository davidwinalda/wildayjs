...
// Log all methods added to CustomQueryBuilder
const qbMethods = Object.getOwnPropertyNames(
  CustomQueryBuilder.prototype
).filter(
  (prop) =>
    typeof CustomQueryBuilder.prototype[prop] === "function" &&
    prop !== "constructor"
);
console.log("CustomQueryBuilder has the following methods:", qbMethods);
