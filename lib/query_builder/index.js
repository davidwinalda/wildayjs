...
const queryBatches = require("./features/queryBatches");
const queryTransactions = require("./features/queryTransactions");
...
queryBatches(CustomQueryBuilder);
queryTransactions(CustomQueryBuilder);
